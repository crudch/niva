        ...
        <div class="row h-100 align-items-center">
            <div class="col-12">
                <div class="breadcrumb-content">
                    <h2 class="breadcrumb-title">Отзывы</h2>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a href="/">Главная</a></li>
                            <li class="breadcrumb-item active"><a href="#">Все категории</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <ul id="nav_accordion" class="nav flex-column">
            ...
            <li class="accordion-item">
                ...
                <ul id="menu-item-{{ $category->id }}" class="submenu collapse">
                    ...
                    <li>
                        <a class="nav-link" href="{{ route('reviews.test', ['category1' => $category->slug, 'category2' => $child->slug]) }}">
                            {{ $child->title }}
                        </a>
                    </li>
                    @endforeach
