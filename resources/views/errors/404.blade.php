...
<div class="saasbox-error-area section-padding-0-120">
    <div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="col-12 col-sm-10 col-md-9 col-lg-7"><img class="mb-5" src="/img/custom-img/404.png" alt="">
                <h5>Ой-ой, страница исчезла</h5>
                <p>По такому запросу не нашлось результатов. Попробуйте снова.</p><a class="btn saasbox-btn mt-4" href="/">на главную</a>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-12 col-lg-2">
                ...
                <div class="language-dropdown text-center text-lg-right mt-4 mt-lg-0">
                    <div class="btn-group dropup">
                        <button class="btn saasbox-btn-2 dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Выбор языка</button>
